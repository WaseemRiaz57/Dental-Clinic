            ...
            <div className="bg-white p-8 md:p-12 rounded-[24px] editorial-shadow reveal-up reveal-delay-2">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-widest text-[#44474f] mb-2">{formNameLabel}</label>
                    <input className="w-full bg-[#f0f4fb] border-none rounded-[10px] px-4 py-3 text-sm focus:ring-2 focus:ring-[#0061a2]/30 focus:bg-white transition-all outline-none" placeholder={formNamePlaceholder} type="text" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-widest text-[#44474f] mb-2">{formPhoneLabel}</label>
                    <input className="w-full bg-[#f0f4fb] border-none rounded-[10px] px-4 py-3 text-sm focus:ring-2 focus:ring-[#0061a2]/30 focus:bg-white transition-all outline-none" placeholder={formPhonePlaceholder} type="tel" />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-bold uppercase tracking-widest text-[#44474f] mb-2">{formServiceLabel}</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-widest text-[#44474f] mb-2">{formDateLabel}</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-widest text-[#44474f] mb-2">{formTimeLabel}</label>
                ...
                <div>
                  <label className="block text-xs font-bold uppercase tracking-widest text-[#44474f] mb-2">{formMessageLabel}</label>
                  <textarea className="w-full bg-[#f0f4fb] border-none rounded-[10px] px-4 py-3 text-sm focus:ring-2 focus:ring-[#0061a2]/30 focus:bg-white transition-all outline-none" placeholder={formMessagePlaceholder} rows={3} />
                </div>
